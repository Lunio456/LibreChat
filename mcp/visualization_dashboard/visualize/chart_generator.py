...
from visualize.config import config_manager

# Import specific config types for type hinting
from visualize.config import VisualizationConfig
...
class ChartGenerator:
    ...
    def create_sample_chart(self, chart_type: ChartType = ChartType.BAR) -> str:
        ...
        try:
            ...
            html_widget = self.generate_chart(
...
def create_quick_chart(chart_type: str, df: pd.DataFrame, **mappings) -> str:
    ...
    html_widget = generator.generate_chart(chart_type_enum, df, mappings)
    return html_widget
